...
# Новый промпт с разделённым пунктом 6
base_prompt = """
...
- В пункте 6 оцени мессенджеры и площадки для ниши (если данных нет — типичные для региона/тематики).
...
6. Мессенджеры и площадки:
   6.1 Мессенджеры (%):
   6.2 Площадки (какие лучше подходят, например Avito, OLX, Wildberries и т.д.):
...
# Промпт для переделки пункта 7 (ссылки конкурентов)
